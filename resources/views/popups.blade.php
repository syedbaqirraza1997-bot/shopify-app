                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-4">
                            <input type="checkbox" name="sales_popup_enabled" class="form-check-input" id="popupEnabled"
                                {{ $settings->sales_popup_enabled ?? true ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="sales_popup_position" class="form-select">
                                        <option value="bottom-left"
                                            {{ ($settings->sales_popup_position ?? 'bottom-left') == 'bottom-left' ? 'selected' : '' }}>
                                            Bottom Left</option>
                                        <option value="bottom-right"
                                            {{ ($settings->sales_popup_position ?? 'bottom-left') == 'bottom-right' ? 'selected' : '' }}>
                                            Bottom Right</option>
                                        <option value="top-left"
                                            {{ ($settings->sales_popup_position ?? 'bottom-left') == 'top-left' ? 'selected' : '' }}>
                                            Top Left</option>
                                        <option value="top-right"
                                            {{ ($settings->sales_popup_position ?? 'bottom-left') == 'top-right' ? 'selected' : '' }}>
                                            Top Right</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="sales_popup_animation" class="form-select">
                                        <option value="slide"
                                            {{ ($settings->sales_popup_animation ?? 'slide') == 'slide' ? 'selected' : '' }}>
                                            Slide</option>
                                        <option value="fade"
                                            {{ ($settings->sales_popup_animation ?? 'slide') == 'fade' ? 'selected' : '' }}>
                                            Fade</option>
                                        <option value="bounce"
                                            {{ ($settings->sales_popup_animation ?? 'slide') == 'bounce' ? 'selected' : '' }}>
                                            Bounce</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="sales_popup_duration" class="form-control"
                                        value="{{ $settings->sales_popup_duration ?? 5000 }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="sales_popup_delay" class="form-control"
                                        value="{{ $settings->sales_popup_delay ?? 10000 }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="sales_popup_max" class="form-control"
                                        value="{{ $settings->sales_popup_max ?? 5 }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sales_popup_data_source" class="form-select">
                                <option value="real"
                                    {{ ($settings->sales_popup_data_source ?? 'real') == 'real' ? 'selected' : '' }}>Real
                                    Orders Only</option>
                                <option value="simulated"
                                    {{ ($settings->sales_popup_data_source ?? 'real') == 'simulated' ? 'selected' : '' }}>
                                    Simulated Data</option>
                                <option value="mixed"
                                    {{ ($settings->sales_popup_data_source ?? 'real') == 'mixed' ? 'selected' : '' }}>Mixed
                                    (Real + Simulated)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="sales_popup_mobile" class="form-check-input" id="showMobile"
                                {{ $settings->sales_popup_mobile ?? true ? 'checked' : '' }}>
                        ...
                        <ul class="list-group list-group-flush">
                            @foreach ($popups->take(5) as $popup)
                                <li class="list-group-item">
                                    <small><strong>{{ $popup->customer_name }}</strong> from
                                        {{ $popup->customer_location }}</small><br>
